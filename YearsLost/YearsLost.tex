...
Figure~\ref{fig:3} mirrors that of figures~\ref{fig:1}, except that the deaths
 decomposed are only deaths with external causes, and external causes have been
 eliminated from the lifetable functions used for decomposition and
 redistribution.
