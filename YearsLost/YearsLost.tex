...
A core task of demography is to explain and predict the population
...
number of deaths deducts relatively smoothly from a wide range of ages,
making mortality mostly invisible in the pyramid, whereas year to year variation
in the number of births is preserved in ages. This is perhaps why the formal
relationships between mortality and age structure have been less charted than
those between births and age structure. 

Demographers most often quantify death in terms of rates and expectancies,
...
life. Demography based on this step is a counterfactual exercise. We will show
that saveable life and lifetime can be quantified flexibly with respect to
demgographic perspectives on age and lifespan. These perspectives refine and
supplement YPLL when assessing the population impacts of causes of death, and we
...
perspectives. We first explain on the example of all-cause
...
the Human Mortality Database\citetalias{HMD}, and propose a few different ways
of arranging and visualizing results for purposes of reporting making
