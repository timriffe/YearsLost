...
causes, and external causes have been eliminated from the lifetable functions used for decomposition and
 ...
 basic for comparison. As with population pyramids, one may prefer the use of
...
major cause groups: cancers, cardiovascular disease, external causes, ill
defined casues, infant and congenital causes, infectious disease, mental
...
released collection from the HMD.
